let faculties = [{
        classFacultiesName: 'cntt',
        address: '(Đ/c: 371 Nguyễn Kiệm, phường 3, Quận Gò Vấp, Tp.HCM)',
        web: 'http://it.ou.edu.vn/',
        facebookFaculty: 'https://www.facebook.com/tinhocmo',
        facebookYouthUnion: '',
        listFaculty: [{
    ...
    {
        classFacultiesName: 'dtdb',
        address: '(Đ/c: 97 Võ Văn Tần, phường 6, Quận 3, TP.HCM)',
        web: 'https://ou.edu.vn/dacbiet/Pages/default.aspx',
        facebookFaculty: 'https://www.facebook.com/KhoaDaotaodacbiet/',
        facebookYouthUnion: 'https://www.facebook.com/DoanHoiDTDB/',
        listFaculty: [{
            ...
            },
            {
                ...
                imageScr: 'assets/images/postGr/post-14.jpg',
                linkIntro: 'javascript:void(0)'
            }
        ]
    },
    {
        classFacultiesName: 'ktkt',
        address: '(Đ/c: 371 Nguyễn Kiệm, phường 3, Quận Gò Vấp, Tp.HCM)',
        web: 'http://v1.ou.edu.vn/ktkt/Pages/default_new.aspx',
        facebookFaculty: 'https://www.facebook.com/KTKT.OU/',
        facebookYouthUnion: 'https://www.facebook.com/KeKiemOU/',
        listFaculty: [{
    ...
    {
        classFacultiesName: 'qtkd',
        address: '(Đ/c: 02 Mai Thị Lựu, Phường Đakao, Q.1, TP.HCM)',
        web: 'http://kqtkd.ou.edu.vn/',
        facebookFaculty: 'https://www.facebook.com/qtkd212/',
        facebookYouthUnion: 'https://www.facebook.com/doanhoibaou2/',
        listFaculty: [{
    ...
    {
        classFacultiesName: 'cnsh',
        address: '(Đ/c: 371 Nguyễn Kiệm, phường 3, Quận Gò Vấp, Tp.HCM)',
        web: 'https://ou.edu.vn/cnsh/Pages/defaultnew.aspx',
        facebookFaculty: '',
        facebookYouthUnion: 'https://www.facebook.com/doanhoibio.ou/',
        listFaculty: [{
    ...
    {
        classFacultiesName: 'xd',
        address: '(Đ/c: 371 Nguyễn Kiệm, phường 3, Quận Gò Vấp, Tp.HCM)',
        web: 'http://ce.ou.edu.vn/',
        facebookFaculty: 'https://www.facebook.com/xaydungtruongdaihocMo/',
        facebookYouthUnion: 'https://www.facebook.com/doanhoixdd/',
        listFaculty: [{
    ...
    {
        classFacultiesName: 'l',
        address: '(Đ/c: 371 Nguyễn Kiệm, phường 3, Quận Gò Vấp, Tp.HCM)',
        web: 'http://khoaluat.ou.edu.vn/',
        facebookFaculty: 'https://www.facebook.com/khoaluat.ou/',
        facebookYouthUnion: '',
        listFaculty: [{
    ...
    {
        classFacultiesName: 'ktqlc',
        address: '(Đ/c: 02 Mai Thị Lựu, P.Đakao, Q.1 Tp.HCM)',
        web: 'http://v1.ou.edu.vn/ktqlc/Pages/default.aspx',
        facebookFaculty: 'https://www.facebook.com/khoakinhtevaquanlycongOU/',
        facebookYouthUnion: 'https://www.facebook.com/KinhCongOU',
        listFaculty: [{
            ...
            },
            {
                ...
                imageScr: 'assets/images/postGr/post-9.jpg',
                linkIntro: 'javascripts:;'
            }
        ]
    },
    {
        classFacultiesName: 'tcnh',
        address: '(Đ/c: 371 Nguyễn Kiệm, phường 3, Quận Gò Vấp, Tp.HCM)',
        web: 'http://tcnh.ou.edu.vn/',
        facebookFaculty: 'https://www.facebook.com/ou.tcnh',
        facebookYouthUnion: 'https://www.facebook.com/khoaTCNH.OU/',
        listFaculty: [{
    ...
    {
        classFacultiesName: 'nn',
        address: '(Đ/c: 371 Nguyễn Kiệm, phường 3, Quận Gò Vấp, Tp.HCM)',
        web: 'https://ou.edu.vn/nn/Pages/Default.aspx',
        facebookFaculty: 'https://www.facebook.com/FFLHCMCOU',
        facebookYouthUnion: 'https://www.facebook.com/DoanHoiFFL/',
        listFaculty: [{
    ...
    {
        classFacultiesName: 'xcd',
        address: '(Đ/c: 371 Nguyễn Kiệm, phường 3, Quận Gò Vấp, Tp.HCM)',
        web: 'http://xhh.ou.edu.vn/',
        facebookFaculty: 'https://www.facebook.com/sukienxacongdongou/',
        facebookYouthUnion: '',
        listFaculty: [{
...
let facultiesRender = document.querySelector('#faculty-list')
renderFaculty = (faculties) => {
    faculties.forEach(e => {
        e.listFaculty.forEach(el => {
            let prod = `
            <!-- ${el.facultyName} -->
            ...
            <div class="faculty single-blog mb-30">
                ...
                <div class="blog-content">
                    ...
                    <p class="mt-10">
                        <b>Giới thiệu/review ngành:</b>
                        <a href="${el.linkIntro}">Nhấn vào đây !</a>
                    </p>
                    <p>
                        <b>Website khoa:</b>
                        <a href="${e.web}">Nhấn vào đây !</a>
                    </p>
                </div>
            </div>
        </div>
`
            facultiesRender.insertAdjacentHTML("beforeend", prod)
        })
